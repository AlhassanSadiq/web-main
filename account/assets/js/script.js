...
const cryptoLinks = document.querySelectorAll('.crypto-list a');

cryptoLinks.forEach(link => {
    link.addEventListener('click', function (event) {
        event.preventDefault();
        const cryptoName = this.textContent.trim();
        alert(`You have selected to pay with ${cryptoName}`);
        // Add logic for cryptocurrency payment here
    });
});
