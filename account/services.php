...
/* Style the services and countries sections */
.services, .countries {
  margin-top: 20px;
}

/* Style the service items and country items */
.service-items, .country-items {
  margin-top: 10px;
}

/* Style the service and country select inputs */
.input {
  width: 100%;
  padding: 10px;
...
/* Style the button */
button {
  background-color: #06002E; /* Background color you specified */
  color: #fff;
  border: none;
  padding: 10px 20px;
...
button:hover {
  background-color: #04001A; /* Darker color on hover */
}
